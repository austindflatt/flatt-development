...
import { BrandInstagram, BrandTwitter, BrandFacebook, BrandLinkedin } from 'tabler-icons-react';
    ...
    <div className={classes.footer}>
      <Container size="xl" className={classes.wrapper}>
        <div className={classes.inner}>
          ...
          © 2022 Flatt Development, LLC
          </Title>
          <Group spacing="xs" position="right" className={classes.social} noWrap>
            <a href='https://www.facebook.com/flattdevelopment' target="_blank" rel="noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" className="icon" width="35" height="40" viewBox="0 0 24 24" fill="#000">
              <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 8h-1.35c-.538 0-.65.221-.65.778v1.222h2l-.209 2h-1.791v7h-3v-7h-2v-2h2v-2.308c0-1.769.931-2.692 3.029-2.692h1.971v3z"/>
            </svg>
            </a>
            <a href='https://twitter.com/flattdev' target="_blank" rel="noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" className="icon" className="icon" width="35" height="40" viewBox="0 0 24 24" fill="#000">
