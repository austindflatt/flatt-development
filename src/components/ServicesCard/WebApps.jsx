...
export function WebApps() {
  ...
  return (
    <Link to="/services/electron" style={{ textDecoration: 'none' }}>
        ...
        <div>
          <div className={classes.icon}>🖥</div>
            ...
            <Text weight={500} className={classes.serviceDescription}>
              We build amazing lightning-fast cross-platform desktop applications with Electron JS that will satisfy every end-user.
            </Text>
        </div>
      </Group>
    </Paper>
