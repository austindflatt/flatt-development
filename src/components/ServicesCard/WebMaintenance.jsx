...
export function WebMaintenance() {
      ...
      <Group style={{ padding: '24px' }}>
        <div>
          ...
          <Text weight={500} className={classes.serviceDescription}>
            With our care plans, you will have full confidence that your web app/website is online and operating as it should 24/7, without interruption.
          </Text>
        </div>
      </Group>
    </Paper>
