  ...
  return (
    ...
    <div className={classes.hero}>
      ...
      <div className={classes.content}>
        <Title className={classes.title}>TypeScript development services</Title>
		<Text className={classes.description} size="xl" mt="xl">
		Closely related to JavaScript, TypeScript is one of our favorite technologies. Leverage our wealth of experience in TS to build faster and more scalable web applications.
        </Text>
...
Why we use TypeScript at Flatt Development
        </Title>
    <Text className="paragraph">
    The larger and more ambitious your project, the more you can benefit from TypeScript. Flatt Development uses it both on frontend and backend to make the development process more efficient and enjoyable.
        </Text>
        </div>
        <div>
