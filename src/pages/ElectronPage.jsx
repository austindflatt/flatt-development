  ...
  return (
    ...
    <div className={classes.hero}>
      ...
      <div className={classes.content}>
        <Title className={classes.title}>Electron development services</Title>
		<Text className={classes.description} size="xl" mt="xl">
		If you need a scalable cross-platform application that works well with all JS frameworks and libraries, Electron is your best bet. And we’re happy to help.
        </Text>
...
<Title className="page-header">
            Why we use Electron JS at Flatt Development
        </Title>
    <Text className="paragraph">
    Electron JS is a framework based on Node.js and Chromium that enables us to build desktop applications using standard web technologies like HTML, CSS and, of course, JavaScript. 
	The desktop apps built with Electron JS can be easily packaged for Mac, Linux or Windows. See some of our Electron JS projects.
        </Text>
        </div>
        <div>
    ...
    Accelerate your mobile app development.
	  ...
	  <Text className={classes.subHeader}>
		Build your mobile app with Louisville, KY's top JavaScript experts
      </Text>
      ...
      <Text className={classes.subHeader}>
      When we started we decided to be the best at JavaScript and never looked back. Specialization is underrated.
      </Text>
