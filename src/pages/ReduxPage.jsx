  ...
  return (
    ...
    <div className={classes.hero}>
      ...
      <div className={classes.content}>
        <Title className={classes.title}>Redux development services</Title>
		<Text className={classes.description} size="xl" mt="xl">
		Manage and centralize your applications state with Redux. Redux can be used together with our favorite technology - React, or with any other view library. It is tiny (2kB, including dependencies), but has a large ecosystem of addons available.
        </Text>
