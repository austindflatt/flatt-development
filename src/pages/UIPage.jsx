  ...
  return (
    ...
    <div className={classes.hero}>
      ...
      <div className={classes.content}>
        <Title className={classes.title}>UX/UI Design services</Title>
		<Text className={classes.description} size="xl" mt="xl">
    Build digital products with exceptional UX.
        </Text>
    ...
    Boost your digital product with UX/UI design.
	  ...
	  <Text className={classes.subHeader}>
		Build web, mobile and desktop apps that address users’ needs.
      </Text>
      ...
      <Text className={classes.subHeader}>
      Work with Louisville, KY's top product and UX/UI designers.
      </Text>
