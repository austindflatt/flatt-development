  ...
  return (
    ...
    <div className={classes.hero}>
      ...
      <div className={classes.content}>
        <Title className={classes.title}>Mobile app development services</Title>
		<Text className={classes.description} size="xl" mt="xl">
    Build a cross-platform mobile app with React Native experts.
        </Text>
...
<Title className="page-header">
            Goal-oriented mobile solutions – are you ready for next-level mobile app development?
        </Title>
