  ...
  return (
    ...
    <div className={classes.hero}>
      ...
      <div className={classes.content}>
        <Title className={classes.title}>Node.js development services</Title>
...
<Title className="page-header">
    ...
    We keep our way of working extremely simple: solve real business problems, over-communicate with partners and never compromise on code quality. 
    The fact that we're considered one of the top Node.js development companies and work on the most exciting Node.js projects, proves it's probably the right way.
        </Text>
        </div>
        <div>
