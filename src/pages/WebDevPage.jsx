  ...
  return (
    ...
    <div className={classes.hero}>
      ...
      <div className={classes.content}>
        <Title className={classes.title}>Web app development services</Title>
		<Text className={classes.description} size="xl" mt="xl">
        Experts in: JavaScript, TypeScript, Node.js, ElectronJS, Next.js, Vue and ReactJS.
        </Text>
...
<Title className="page-header">
            We focus on the fastest route to market – respecting your time and pushing your web app to success.
        </Title>

    <Text className="paragraph">
	Scale your web app development with experienced full-stack developers and product experts from one of the top JavaScript development companies in Louisville, KY.
        </Text>
        </div>
	  ...
	  <Text className={classes.subHeader}>
		In tech, time is everything. But you know that.
      </Text>
