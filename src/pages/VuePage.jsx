  ...
  return (
    ...
    <div className={classes.hero}>
      ...
      <div className={classes.content}>
        <Title className={classes.title}>Vue development services</Title>
		<Text className={classes.description} size="xl" mt="xl">
		Develop and upgrade your apps with a modern and lightweight JavaScript framework.
        </Text>
...
Why we use Vue at Flatt Development
        </Title>
    <Text className="paragraph">
    Vue.js lives up to the promise. It provides tons of features in a couple of kilobytes. Thanks to them, you can create high-performance web apps or extend existing ones based on other JavaScript frameworks. No wonder, there are now a lot of Vue.js developers. But this means that finding really good ones may be difficult. Our developers makes it easy.
        </Text>
        </div>
        <div>
